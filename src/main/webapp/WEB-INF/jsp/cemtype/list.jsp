						...
						<form:form modelAttribute="searchModel" class="form-horizontal" method="GET">
							...
							<div class="row">
								<div class="col-md-3 col-sm-3">
									<label style="float:left;" for="cusName">墓型管理：</label>
									<form:input path="name" name="name" class="form-control placeholder-no-fix" autocomplete="off" placeholder="墓型名称" />
									<form:input path="code" name="code" class="form-control placeholder-no-fix" autocomplete="off" placeholder="墓型编号" />
